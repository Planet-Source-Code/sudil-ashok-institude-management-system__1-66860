...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment1 
   ...
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=E:\project1\MainData.mdb;Persist Security Info=False"
      Expanded        =   -1  'True
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
   ...
   BeginProperty Recordset2 
      ...
      CommDispId      =   1007
      RsDispId        =   1032
      CommandText     =   $"DataEnvironment1.dsx":00A6
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "StudentID_Grouping"
      IsRSReturning   =   -1  'True
      NumFields       =   12
      BeginProperty Field1 
         Precision       =   0
   ...
   BeginProperty Recordset3 
      ...
      CommDispId      =   1033
      RsDispId        =   1038
      CommandText     =   $"DataEnvironment1.dsx":028F
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Grouping        =   -1  'True
   ...
   BeginProperty Recordset4 
      ...
      CommDispId      =   1039
      RsDispId        =   1043
      CommandText     =   $"DataEnvironment1.dsx":0482
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Prepared        =   -1  'True
      Grouping        =   -1  'True
      GroupingName    =   "Command4_Grouping"
      IsRSReturning   =   -1  'True
      NumFields       =   14
      BeginProperty Field1 
         Precision       =   0
   ...
   BeginProperty Recordset5 
      ...
      CommDispId      =   1044
      RsDispId        =   1048
      CommandText     =   $"DataEnvironment1.dsx":0664
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command5_Grouping"
      IsRSReturning   =   -1  'True
      NumFields       =   5
      BeginProperty Field1 
         Precision       =   0
   ...
   BeginProperty Recordset6 
      ...
      CommDispId      =   1049
      RsDispId        =   1053
      CommandText     =   $"DataEnvironment1.dsx":0735
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command6_Grouping"
   ...
   BeginProperty Recordset7 
      ...
      CommDispId      =   1054
      RsDispId        =   1088
      CommandText     =   $"DataEnvironment1.dsx":08A1
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command7_Grouping"
      Expanded        =   -1  'True
      SummaryExpanded =   -1  'True
      DetailExpanded  =   -1  'True
      IsRSReturning   =   -1  'True
   ...
   BeginProperty Recordset8 
      ...
      CommDispId      =   1064
      RsDispId        =   1087
      CommandText     =   $"DataEnvironment1.dsx":0A46
      ActiveConnectionName=   "Connection1"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command8_Grouping"
      SummaryExpanded =   -1  'True
      DetailExpanded  =   -1  'True
      IsRSReturning   =   -1  'True
      NumFields       =   9
